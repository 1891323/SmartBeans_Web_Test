...
<script>
$( function() {
const weeklyChartArea = document.getElementById('userSurvayChart').getContext('2d');
	let  weeklyChart = new Chart(weeklyChartArea, {
		type: 'bar',
		data: {
