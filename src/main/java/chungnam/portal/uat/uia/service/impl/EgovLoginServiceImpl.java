package chungnam.portal.uat.uia.service.impl;
...
import chungnam.portal.cop.ems.service.EgovSndngMailRegistService;
import chungnam.portal.cop.ems.vo.SndngMailVO;
import chungnam.portal.uat.uia.mapper.LoginMapper;
import chungnam.portal.uat.uia.service.EgovLoginService;
import chungnam.portal.utl.fcc.service.EgovNumberUtil;
import chungnam.portal.utl.fcc.service.EgovStringUtil;
import chungnam.portal.utl.sim.service.EgovFileScrty;
...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements EgovLoginService {
    ...
    private void updateLoginIncorrect(Map<?, ?> mapParam) throws Exception {
    	if("ENT".equals(mapParam.get("USER_SE"))) {
    		loginDAO.updateLoginIncorrectENT(mapParam);
    	} else if("GNR".equals(mapParam.get("USER_SE"))) {
    		loginDAO.updateLoginIncorrectGNR(mapParam);
    	} else if("USR".equals(mapParam.get("USER_SE"))) {
    		loginDAO.updateLoginIncorrectUSR(mapParam);
    	}
    }
