 ...
 */
package smartbeans.portal.sym.mpm.service;
...
public interface PrgrmService {
	...
	PrgrmVO insertPrgrm(PrgrmVO vo) throws Exception;
	...
	List<?> selectPrgrmListForAuth(ComDefaultVO searchVO) throws Exception;
